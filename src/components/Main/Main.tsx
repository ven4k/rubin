import { ChangeEvent, FC, Fragment, useEffect, useState, MouseEvent } from 'react';
            ...
            {posts.length ? (
                <>
                    <div className={styles.inputBlock}>
                        <input type='text' placeholder='Text post' value={inputValue} onChange={(e) => setInputValue(e.target.value)} />
